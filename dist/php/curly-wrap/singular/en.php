...
array (
  ...
  array (
    ...
    array (
      'title' => 'Purpose',
      'session' => 'The so called "Session" cookie allows my website to store and retrieve information about your current visit (e.g. the selected language or login-state).',
      ...
      'analytics_third_party' => 'These cookies are written by the web analytics tool, which allows me to understand and improve user experience and is used for statistical purposes. (For more info see the [web analytics section](#process-analytics).)',
