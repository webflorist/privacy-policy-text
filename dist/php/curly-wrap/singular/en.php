...
array (
  ...
  array (
    ...
    array (
      ...
      'text' => '
                <p>
                    My website provides the functionality of interactive maps on demand (e.g. for calculating routes) using the service <strong>{maps_service}</strong> provided by <a href="#service-providers-{maps_provider_key}">{maps_provider_name}</a>.
                </p>
                <p>
