...
return [
	...
	'data_processing' => [
		...
		'maps' => [
			...
			'content' => [
				'p1' =>
					'Our website provides the functionality of interactive maps on demand (e.g. for calculating routes) using the service **{maps_service}** provided by {maps_processor}.',
				'p2' =>
		...
		'send_emails' => [
			...
			'content' => [
				'p1' =>
					'Our website includes forms, that can be used to send us an e-mail. The form collects your name, e-mail-address as well other data. When submitting the form, this data will be transmitted via the service **{send_emails_service}** of our processor {send_emails_processor} into our mailbox.',
			],
		],
	],
	'outgoing_links' => [
