...
array (
  ...
  array (
    ...
    'text' => '
            <p>
                Wir behandeln Ihre Daten in Übereinstimmung mit der Wir Europäischen Datenschutzgrundverordnung (&quot;DSGVO&quot;). Diese gibt Privatpersonen weitgehende Rechte über die Art und Weise, wie ihre persönlichen Daten gesammelt und verarbeitet werden. Diese Rechte beinhalten:
            </p>
            <ul>
  ...
  array (
    ...
    array (
      ...
      'analytics_third_party' => 'Diese Cookies werden vom Web-Analyse-Tool "Google Analytics" erstellt, welches wir zum verstehen und verbessern des Benutzerverhaltens nutzen. (Mehr Informationen hierzu finden Sie weiter unten im Web-Analyse-Abschnitt.)',
  ...
  array (
    ...
    array (
      ...
      'text' => '
                <p>
                    Unsere Webseite bietet auf Anforderung die Funktionalität zur Darstellung interaktiver Karten (z.B. zur Erstellung von Anfahrtsplänen). Dabei wird ein Dienst von <a href="#service-providers-maps_provider_key">maps_provider_name</a> verwendet.
                </p>
                <p>
