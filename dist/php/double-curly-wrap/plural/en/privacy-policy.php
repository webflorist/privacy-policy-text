...
return [
	...
	'data_controller' => [
		...
		'content' => [
			'p1' =>
				'The data controller is the person or company responsible for the purposes and types of processing of personal data (e.g. name, e-mail-addresses, etc.). In case of our website that is:',
		],
	],
	'security' => [
		'title' => 'Data Security',
	...
	'data_processing' => [
		...
		'maps' => [
			...
			'content' => [
				'p1' =>
					'Our website provides the functionality of interactive maps on demand (e.g. for calculating routes). This will transmit data to {{maps_processor}}.',
				'p2' =>
					'If you accept the corresponding data processing, the map will be displayed and personal data (like usage and location) will be sent to {{maps_processor}} and needed cookies will be set.',
				'p3' =>
		...
		'send_emails' => [
			...
			'content' => [
				'p1' =>
					'Our website includes forms, that can be used to send us an e-mail. The form collects your name, e-mail-address as well other data. When submitting the form, this data will be transmitted via {{send_emails_processor}} into our mailbox.',
			],
		],
	],
	'outgoing_links' => [
