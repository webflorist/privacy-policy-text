...
return [
	...
	'security' => [
		...
		'content' => [
			...
			'p2' =>
				'All data will be stored on servers of my our data processors. Collection and usage of this data is based on contracts with those processors according to Article 28 of the GDPR.',
		],
	],
	'cookies' => [
		'title' => 'Cookies',
		...
		'no_cookies_content' => [
			'p1' =>
				'Websites often use so called "cookies", which are small text files processed and stored on your device by your web browser to provide certain functionality. My website does not use any cookies.',
		],
		'first_party' => [
			'title' => 'First Party Cookies',
			'content' => [
				'p1' =>
					'Here is a complete overview of all technically mandatory **"first-party-cookies"** set by my website:',
			],
		],
		'third_party' => [
			...
			'content' => [
				'p1' =>
					'And these are the **"third-party-cookies"** set by using various parts of my website:',
			],
		],
		'name' => 'Name',
		'origin' => 'Origin',
	...
	'data_processing' => [
		...
		'maps' => [
			...
			'content' => [
				'p1' =>
					'My website provides the functionality of interactive maps on demand (e.g. for calculating routes). This will transmit data to :maps_processor.',
				'p2' =>
		...
		'send_emails' => [
			...
			'content' => [
				'p1' =>
					'My website includes forms, that can be used to send me an e-mail. The form collects your name, e-mail-address as well other data. When submitting the form, this data will be transmitted via :send_emails_processor into my mailbox.',
			],
		],
	],
	'outgoing_links' => [
