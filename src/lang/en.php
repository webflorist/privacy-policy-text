...
return [
	...
	'data_controller' => [
		...
		'content' => [
			'p1' =>
				'The data controller is the person or company responsible for the purposes and types of processing of personal data (e.g. name, e-mail-addresses, etc.). In case of ' .
				($s ? 'my' : 'our') .
				' website that is:',
		],
	],
