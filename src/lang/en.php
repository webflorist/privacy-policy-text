...
return [
    ...
    'cookies' => [
        ...
        'no_cookies' => '
            <p>
                Websites often use so called "cookies", which are small text files processed and stored on your device by your web browser to provide certain functionality. ' . ($s ? 'My' : 'Our') . ' website does not use any cookies.
            </p>
        ',
        'first_party' => [
    ...
    'data_collection' => [
        ...
        'maps' => [
            ...
            'text' => '
                <p>
                    ' . ($s ? 'My' : 'Our') . ' website provides the functionality of interactive maps on demand (e.g. for calculating routes) using the service <strong>' . $i('maps_service') . '</strong> provided by <a href="#service-providers-' . $i('maps_provider_key') . '">' . $i('maps_provider_name') . '</a>.
                </p>
                <p>
                    A corresponding data protection notice will be shown on accessing an interactive map for the first time. The map will only be shown, if you accept this notice. As a result personal data (like usage and location) will be sent to ' . $i('maps_service') . ' and needed cookies will be set.
                </p>
                <p>
