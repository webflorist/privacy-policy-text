...
return [
    ...
    'cookies' => [
        ...
        'no_cookies' => '
            <p>
                Websiten verwenden oft so genannte &quot;Cookies&quot;. Dabei handelt es sich um kleine Textdateien, die mit Hilfe des Browsers auf Ihrem Endgerät verarbeitet und abgelegt werden, um bestimmte Funktionen der Webseite zu gewährleisten.' . ($s ? 'Meine' : 'Unsere') . ' Website verwendet keinerlei "Cookies".
            </p>
        ',
        'first_party' => [
    ...
    'data_collection' => [
        ...
        'maps' => [
            ...
            'text' => '
                <p>
                    ' . ($s ? 'Meine' : 'Unsere') . ' Webseite bietet auf Anforderung die Funktionalität zur Darstellung interaktiver Karten (z.B. zur Erstellung von Anfahrtsplänen). Dabei wird der Dienst <strong>' . $i('maps_service') . '</strong> von <a href="#service-providers-' . $i('maps_provider_key') . '">' . $i('maps_provider_name') . '</a> verwendet.
                </p>
                <p>
